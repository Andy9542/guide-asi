...
## Визуальные материалы — CC BY-SA 4.0

Авторские обложки и графика в `assets/brand/` распространяются под CC BY-SA 4.0
с той же атрибуцией, что и текст гайда. Они не содержат логотипа OWASP.
