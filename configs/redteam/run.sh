...
# INT и TERM переводятся в exit, чтобы сработал EXIT: под dash сигнал убивает оболочку
# без него, и копия конфига с ключом провайдера оставалась бы во временном каталоге.
