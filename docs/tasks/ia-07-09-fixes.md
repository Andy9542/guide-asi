...
**Goal:** достигнут в части кода и проверок: контрпримеры IA-09 и IA-07 воспроизведены на `c122657` и закрыты, контроли сохранены, smoke → 0; пуш `c325ee8` → CI run [35963711061](https://github.com/Andy9542/guide-asi/actions/runs/35963711061) success. Итоговая вершина PR — коммит с этим текстом; его run и описание — в PR #1.
...
**Status:** done — IA-09 и IA-07 закрыты, ревью и повторное ревью без находок, упрощения и правка текстов применены, CI зелёный на `c325ee8`; описание PR #1 обновлено после зелёного run итоговой вершины.
